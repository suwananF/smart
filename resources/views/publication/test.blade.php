...
<div class="container">
  ...
  <h2 id="title">Test Datatable : แสดงหน้าการทำงานของ Datatable</h2>

  <div class="card" style="margin-bottom:20px;">
      <div class="card-body">
        <div class="table-responsive" style="margin-top:20px;">
          <table id="table-publication" class="table table-responsive w-100 d-block d-md-table table-striped table-bordered table-sm">
